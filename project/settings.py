...
load_dotenv()
SECRET_KEY = os.getenv("DJANGO_SECRET_KEY", "your-default-secret-key")  # Move to .env
EMAIL_HOST_USER = os.getenv("EMAIL_HOST_USER")  # Move to .env
EMAIL_HOST_PASSWORD = os.getenv("EMAIL_HOST_PASSWORD")  # Move to .env
...
TEMPLATES = [
    {
        ...
        "DIRS": [os.path.join(BASE_DIR, "templates")],  # ✅ Ensure templates directory is correctly set
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
DATABASES = {
    "default": {
        "ENGINE": "django.db.backends.sqlite3",  # ✅ Ensure ENGINE is specified
...
# For production (used with `collectstatic`)
